...
from admin import ShareAdminForm


email_sent = dispatch.Signal(providing_args=["data", ])


class SharePlugin(CMSPluginBase):
    model = Share
    name = _("Share Form")
    render_template = "cmsplugin_shareform/contact.html"
    form = ShareAdminForm
    subject_template = "cmsplugin_shareform/subject.txt"
    email_template = "cmsplugin_shareform/email.txt"
    ...
    change_form_template = "cmsplugin_shareform/admin/plugin_change_form.html"
    ...
    def get_form(self, request, obj=None, **kwargs):
        ...
        return super(SharePlugin, self).get_form(request, obj, **kwargs)
    ...
    def render_change_form(self, request, context, add=False, change=False, form_url='', obj=None):
        ...
        return super(SharePlugin, self).render_change_form(request, context, add, change, form_url, obj)


plugin_pool.register_plugin(SharePlugin)
