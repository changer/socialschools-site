...
# Feel free to extend this class instead of Price.
from socialschools_site.apps.cmsplugin_price import settings


class BasePrice(CMSPlugin):
    ...
    form_layout = models.CharField(_('Form Layout'),
                                   ...
                                   choices=settings.CMSPLUGIN_PRICE_FORMS
                                   )
