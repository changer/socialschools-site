...
class ContactPlugin(CMSPluginBase):
    model = Contact
    name = _("Contact Form")
    render_template = "cmsplugin_question/contact.html"
    form = ContactAdminForm
    subject_template = "cmsplugin_question/subject.txt"
    email_template = "cmsplugin_question/email.txt"
    ...
    change_form_template = "cmsplugin_question/admin/plugin_change_form.html"
