...
from models import Juncampaign
from forms import AkismetContactForm, RecaptchaContactForm, HoneyPotContactForm
from admin import JuncampaignAdminForm


email_sent = dispatch.Signal(providing_args=["data", ])


class JuncampaignPlugin(CMSPluginBase):
    model = Juncampaign
    name = _("Juncampaign Form")
    render_template = "cmsplugin_juncampaign/juncampaign.html"
    form = JuncampaignAdminForm
    subject_template = "cmsplugin_juncampaign/subject.txt"
    email_template = "cmsplugin_juncampaign/email.txt"
    ...
    change_form_template = "cmsplugin_juncampaign/admin/plugin_change_form.html"
    ...
    def get_form(self, request, obj=None, **kwargs):
        ...
        return super(JuncampaignPlugin, self).get_form(request, obj, **kwargs)
    ...
    def create_form(self, instance, request):
        ...
        if instance.get_spam_protection_method_display() == 'Akismet':
            ...
            class JuncampaignForm(ContactFormBase, AkismetContactForm):
                pass
            FormClass = JuncampaignForm
            ...
            class JuncampaignForm(ContactFormBase, RecaptchaContactForm):
            ...
            class JuncampaignForm(ContactFormBase, HoneyPotContactForm):
                pass
            FormClass = JuncampaignForm
    ...
    def render_change_form(self, request, context, add=False, change=False, form_url='', obj=None):
        ...
        return super(JuncampaignPlugin, self).render_change_form(request, context, add, change, form_url, obj)


plugin_pool.register_plugin(JuncampaignPlugin)
