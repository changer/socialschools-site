...
from models import Notcampaign
from forms import AkismetContactForm, RecaptchaContactForm, HoneyPotContactForm
from admin import NotcampaignAdminForm


email_sent = dispatch.Signal(providing_args=["data", ])


class NotcampaignPlugin(CMSPluginBase):
    model = Notcampaign
    name = _("NOT 2015 Campaign Form")
    render_template = "cmsplugin_notcampaign/notcampaign.html"
    form = NotcampaignAdminForm
    subject_template = "cmsplugin_notcampaign/subject.txt"
    email_template = "cmsplugin_notcampaign/email.txt"
    ...
    change_form_template = "cmsplugin_notcampaign/admin/plugin_change_form.html"
    ...
    def get_form(self, request, obj=None, **kwargs):
        ...
        return super(NotcampaignPlugin, self).get_form(request, obj, **kwargs)
    ...
    def create_form(self, instance, request):
        ...
        if instance.get_spam_protection_method_display() == 'Akismet':
            ...
            class NotcampaignForm(ContactFormBase, AkismetContactForm):
                pass
            FormClass = NotcampaignForm
            ...
            class NotcampaignForm(ContactFormBase, RecaptchaContactForm):
            ...
            class NotcampaignForm(ContactFormBase, HoneyPotContactForm):
                pass
            FormClass = NotcampaignForm
    ...
    def render_change_form(self, request, context, add=False, change=False, form_url='', obj=None):
        ...
        return super(NotcampaignPlugin, self).render_change_form(request, context, add, change, form_url, obj)


plugin_pool.register_plugin(NotcampaignPlugin)
